 ...
 * @export
 * @interface AdminconversationsGetTeamsListResponse
 */
export interface AdminconversationsGetTeamsListResponse {
    /**
     * 
     * @type {DefsOkTrue}
     * @memberof AdminconversationsGetTeamsListResponse
     */
    'ok': DefsOkTrue;
    /**
     * 
