 ...
 * @export
 * @interface RemindersCompletedefaultResponse
 */
export interface RemindersCompletedefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof RemindersCompletedefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof RemindersCompletedefaultResponse
     */
    'error': RemindersCompletedefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof RemindersCompletedefaultResponse
