 ...
 * @export
 * @interface MigrationExchangedefaultResponse
 */
export interface MigrationExchangedefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof MigrationExchangedefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof MigrationExchangedefaultResponse
     */
    'error': MigrationExchangedefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof MigrationExchangedefaultResponse
