 ...
 * @export
 * @interface UsersIdentitydefaultResponse
 */
export interface UsersIdentitydefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof UsersIdentitydefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof UsersIdentitydefaultResponse
     */
    'error': UsersIdentitydefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof UsersIdentitydefaultResponse
