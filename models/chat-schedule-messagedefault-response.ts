 ...
 * @export
 * @interface ChatScheduleMessagedefaultResponse
 */
export interface ChatScheduleMessagedefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof ChatScheduleMessagedefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof ChatScheduleMessagedefaultResponse
     */
    'error': ChatScheduleMessagedefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof ChatScheduleMessagedefaultResponse
