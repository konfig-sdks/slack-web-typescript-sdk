 ...
 * @export
 * @interface RemindersAdddefaultResponse
 */
export interface RemindersAdddefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof RemindersAdddefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof RemindersAdddefaultResponse
     */
    'error': RemindersAdddefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof RemindersAdddefaultResponse
