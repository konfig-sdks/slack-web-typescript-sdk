 ...
 * @export
 * @interface StarsRemovedefaultResponse
 */
export interface StarsRemovedefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof StarsRemovedefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof StarsRemovedefaultResponse
     */
    'error': StarsRemovedefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof StarsRemovedefaultResponse
