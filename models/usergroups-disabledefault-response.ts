 ...
 * @export
 * @interface UsergroupsDisabledefaultResponse
 */
export interface UsergroupsDisabledefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof UsergroupsDisabledefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof UsergroupsDisabledefaultResponse
     */
    'error': UsergroupsDisabledefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof UsergroupsDisabledefaultResponse
