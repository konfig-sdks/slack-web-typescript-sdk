 ...
 * @export
 * @interface UsersSetPresencedefaultResponse
 */
export interface UsersSetPresencedefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof UsersSetPresencedefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof UsersSetPresencedefaultResponse
     */
    'error': UsersSetPresencedefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof UsersSetPresencedefaultResponse
