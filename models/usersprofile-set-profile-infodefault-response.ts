 ...
 * @export
 * @interface UsersprofileSetProfileInfodefaultResponse
 */
export interface UsersprofileSetProfileInfodefaultResponse {
    /**
     * Note: PHP callstack is only visible in dev/qa
     * @type {string}
     * @memberof UsersprofileSetProfileInfodefaultResponse
     */
    'callstack'?: string;
    /**
     * 
     ...
     * @memberof UsersprofileSetProfileInfodefaultResponse
     */
    'error': UsersprofileSetProfileInfodefaultResponseErrorEnum;
    /**
     * 
     * @type {DefsOkFalse}
     * @memberof UsersprofileSetProfileInfodefaultResponse
